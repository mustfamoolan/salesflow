...
export default function Login() {
    ...
    return (
        <LandingLayout title="تسجيل الدخول - SalesFlow">
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    <input
                                        ...
                                        } rounded-lg placeholder-gray-400 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm pr-10`}
                        ...
                        <div className="mt-6">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-2 bg-white text-gray-500">أو تسجيل الدخول بـ</span>
                                </div>
                            </div>
